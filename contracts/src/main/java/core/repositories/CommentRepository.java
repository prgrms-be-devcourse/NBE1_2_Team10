...
import core.models.entities.CommentEntity;
...
public interface CommentRepository {
     ...
     */
    CommentEntity saveNewComment(CommentEntity comment);

    /**
     * 특정 영화에 새로운 한줄평 댓글을 DB 에 등록
     *
     * @param movieId 한줄평 댓글을 등록할 영화 ID
     * @param comment 새로운 한줄평 댓글
     * @return {@link CommentEntity} 등록된 정보
     */
    CommentEntity saveNewComment(String movieId, CommentEntity comment);
