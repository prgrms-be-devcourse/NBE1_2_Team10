...
import core.models.entities.ReviewEntity;
...
public interface ReviewRepository {
    ...
    /**
     * 새로운 영화 후기 포스팅을 DB 에 등록
     *
     * @param review 새로운 영화 후기 포스팅
     * @return {@link ReviewEntity} 등록된 정보
     */
    ReviewEntity saveNewReview(ReviewEntity review);

    /**
     * 특정 영화에 새로운 영화 후기 포스팅을 DB 에 등록
     *
     * @param movieId 후기 포스팅을 등록할 영화 ID
     * @param review  새로운 영화 후기 포스팅
     * @return {@link ReviewEntity} 등록된 정보
     */
    ReviewEntity saveNewReview(String movieId, ReviewEntity review);
