...
import core.models.entities.ReviewCommentEntity;
...
public interface ReviewCommentRepository {
     ...
     * @return {@link ReviewCommentEntity} 등록된 정보
     */
    ReviewCommentEntity saveNewParentReviewComment(Long reviewId, ReviewCommentEntity reviewComment);
    ...
    //<editor-fold desc="자식 댓글을 등록">

    /**
     * 특정 포스팅 댓글에 자식 댓글을 등록
     *
     * @param groupId       부모 댓글의 포스팅 댓글 ID
     * @param reviewComment 등록할 댓글 정보
     * @return {@link ReviewCommentEntity} 등록된 정보
     */
    ReviewCommentEntity saveNewChildReviewComment(Long groupId, ReviewCommentEntity reviewComment);
    ...
    // TODO 부모 댓글의 groupId null 로 할건지 아님 서비스 단에서 groupId == reviewCommentId 로 할건지 정해야 됨.

    /**
     * 특정 포스팅에 달린 모든 부모 댓글을 검색.
     * <p>
     * 즉, {@code reviewCommentId == groupId || null} 인 댓글만 검색.
     *
