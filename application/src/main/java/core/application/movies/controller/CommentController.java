...
public class CommentController {
	...
	public ApiResponse<List<CommentRespDTO>> getComments(@PathVariable String movieId,
		@RequestParam int page, @RequestParam String sortType) {
		List<CommentRespDTO> comments;
		// 추후 JWT를 통해 userId 주입
		UUID userId = UUID.fromString("c798c89f-845e-11ef-93ee-d88083a74022");
	...
	public ApiResponse<Message> incrementCommentDislike(@PathVariable Long commentId) {
		...
		return ApiResponse.onCreateSuccess(Message.createMessage("한줄평 좋아요 취소 성공"));
	}
